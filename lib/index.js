(function (global, factory) {
  if (typeof define === 'function' && define.amd) {
    define(['exports', 'module', './util/debounce', './util/element-contains'], factory);
  } else if (typeof exports !== 'undefined' && typeof module !== 'undefined') {
    factory(exports, module, require('./util/debounce'), require('./util/element-contains'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, mod, global.debounce, global.elementContains);
    global.unknown = mod.exports;
  }
})(this, function (exports, module, _utilDebounce, _utilElementContains) {
  'use strict';
  ...
  module.exports = window.SkateMutationObserver = MutationObserver;
});